...
class Sensor(threading.Thread):
    ColorDataToSignal = Signal()
    GenDataToSignal = Signal()
    AckBoolToSignal = Signal()
    def __init__(self):
    ...
    def func(self):
        ...
        while Sensor < 5:
            ...
            self.GenDataToSignal.emit(self.genData)
            
            # Send Violet Raw Data
            self.ColorDataToSignal.emit(self.Raw_List_Vio,"Vio","Raw")
            # Send Violet Cal Data
            self.ColorDataToSignal.emit(self.Cal_List_Vio,"Vio","Cal")
            # Send Blue Raw Data
            self.ColorDataToSignal.emit(self.Raw_List_Blu,"Blu","Raw")
            # Send Blue Cal Data
            self.ColorDataToSignal.emit(self.Cal_List_Blu,"Blu","Cal")
            # Send Green Raw Data
            self.ColorDataToSignal.emit(self.Raw_List_Grn,"Grn","Raw")
            # Send Green Cal Data
            self.ColorDataToSignal.emit(self.Cal_List_Grn,"Grn","Cal")
            # Send Yellow Raw Data
            self.ColorDataToSignal.emit(self.Raw_List_Yel,"Yel","Raw")
            # Send Yellow Cal Data
            self.ColorDataToSignal.emit(self.Cal_List_Yel,"Yel","Cal")
            # Send Orange Raw Data
            self.ColorDataToSignal.emit(self.Raw_List_Org,"Org","Raw")
            # Send Orange Cal Data
            self.ColorDataToSignal.emit(self.Cal_List_Org,"Org","Cal")
            # Send Red Raw Data
            self.ColorDataToSignal.emit(self.Raw_List_Red,"Red","Raw")
            # Send Red Cal Data
            self.ColorDataToSignal.emit(self.Cal_List_Red,"Red","Cal")
            # Acknowledge Execution for save data in csv file
            self.AckBoolToSignal.emit(True)
